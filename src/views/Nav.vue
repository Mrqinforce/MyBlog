...
export default {
	data() {
		return {
			...
			slideList: [
				{ url: '#', description: 'one', image: 'https://cdn.dribbble.com/users/329207/screenshots/7824170/media/cc77353e67ca46a4da78553330209a72.jpg' },
				{ url: '#', description: 'two', image: 'https://cdn.dribbble.com/users/63407/screenshots/7825858/media/547d13eb0522eabcbbaa6683c82bfe40.png' },
				{ url: '#', description: 'three', image: 'https://cdn.dribbble.com/users/1018201/screenshots/7816965/media/2ed92a6a7ee0017e28f3bbcaf88b8138.png' }
			],
			currentIndex: 0,
			timer: null
		};
